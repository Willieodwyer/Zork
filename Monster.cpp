...
Monster::~Monster(){
    qDebug() << "deleting MONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTERMONSTER!!!";
}
//if(canMove(UP))
//    setPos(x(),y()-DISTANCE);
//if(canMove(DOWN))
